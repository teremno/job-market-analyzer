...
1. RawJob â€” original payload collected from a source.
2. JobPosting â€” normalized representation of a posting on one specific source.
3. CanonicalJob â€” a logical real-world vacancy that may be represented by multiple JobPostings.
