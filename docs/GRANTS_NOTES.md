...
- Form long-text screens: problem+why-now; who-it-helps+where; one-line в‰¤80
...
- Missing LICENSE в†’ instant credibility failure for belief #1. Fix first.
- `--language uk` fails today в†’ never claim shipped multilingual until it runs.
- Solo-builder bus factor в†’ mitigate by citing 800+ tests, ADR culture,
